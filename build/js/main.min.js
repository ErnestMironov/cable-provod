...
function menu() {
  var menu = document.querySelector(".menu__wrap");
  var btn = document.querySelector(".menu__burger");
...
// CONCATENATED MODULE: ./src/scripts/utils/catalogToggle.js
...
// CONCATENATED MODULE: ./src/scripts/utils/emParallax.js
...
// EXTERNAL MODULE: ./node_modules/swipe-listener/dist/swipe-listener.min.js
var swipe_listener_min = __webpack_require__(0);
var swipe_listener_min_default = /*#__PURE__*/__webpack_require__.n(swipe_listener_min);

// CONCATENATED MODULE: ./src/scripts/utils/emSlider.js
...
function emSlider(elem) {
  ...
  var listener = swipe_listener_min_default()(slider);
...
// CONCATENATED MODULE: ./src/scripts/utils/sayHello.js
...
function dom7_esm_prev(selector) {
  if (this.length > 0) {
    var el = this[0];
...
/* harmony default export */ var autoplay_autoplay = ({
  name: 'autoplay',
  params: {
    autoplay: {
      enabled: false,
...
core_class.use([autoplay_autoplay, navigation]);
/* harmony default export */ var sliders = (function () {
  var swiper = new core_class(".cloudy-slider", {
    slidesPerView: 2,
    spaceBetween: 20,
    loop: true,
...
var baguetteBox_min = __webpack_require__(1);
...
sliders();
baguetteBox_min_default.a.run('.certificats__slider .swiper-wrapper');
